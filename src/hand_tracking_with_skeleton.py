...
#     """Render both hands' skeletons with sci-fi styling (no distracting pulses)."""
...
#
#     hand_colors = [
#         (0.0, 0.8, 1.0),  # Blue for one hand
#         (1.0, 0.2, 0.2)  # Red for the other hand
#     ]
#
...
#
#         # **Bones**
#         glColor4f(color[0], color[1], color[2], 0.5)  # Semi-transparent glow effect
#         draw_hand_boundary(hand_landmarks)
#
#         # **Joints**
#         glDisable(GL_LIGHTING)
#         glColor3f(color[0], color[1], color[2])  # Solid neon color
